...
import string
import urllib
from common.core.utils import dict_to_xml
...
class WXPayment(object):
    ...
    def __generate_test_out_trade_no(self):
    ...
    def __generate_sign(self, data):
        ...
        param_str = '{0}&key={1}'.format(param_str, settings.WECHAT_APP_SECRET)
        param_str = hashlib.md5(__param_str).hexdigest()
        ret = param_str.upper()
        return ret
    ...
    def get_prepay_id(self, out_trade_no, total_fee, body, openid, notify_url):
        data = {
            ...
            "out_trade_no": self.__generate_test_out_trade_no(), 
            "total_fee": total_fee, 
