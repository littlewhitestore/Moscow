...
urlpatterns = [
    ...
    url(r'^settlement/buynow$', views.SettlementPintuanView.as_view()),
    url(r'^settlement/pintuan$', views.SettlementPintuanView.as_view()),
    url(r'^order/all$', views.OrderListView.as_view()),
    url(r'^order/create/buynow$', views.OrderCreatePintuanView.as_view()),
    url(r'^order/create/pintuan$', views.OrderCreatePintuanView.as_view()),
